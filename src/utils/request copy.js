...
// let HOST = process.env.REACT_APP_HOSTAPI;
// console.log('conf.hosts',conf.hosts)
...
export default function request(url, options = {}) {
    // const newurl = axios.defaults.baseURL + url;
    ...
    if (/(GET)/.test(method)) {
        // newOptions.url = splitUrl(url, Object.assign({}, options.body));
